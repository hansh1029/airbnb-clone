...
class SignUpView(mixins.LoggedOutOnlyView, FormView):
    ...
    # reverse_lazy is used for the variable in class
...
def kakao_callback(request):
    try:
        ...
        try:
            ...
            # You don't need to add user.save() because it is not reuqired for FileField
        messages.success(request, f"Welcome back {user.first_name}")
        login(request, user)
        return redirect(reverse("core:home"))
...
class UserProfileView(DetailView):
    ...
    # below refers to user view found not user logged in. context is what is rendered from template
    context_object_name = "user_obj"

    # can create context with overriding this
...
class UpdateProfileView(mixins.LoggedInOnlyView, SuccessMessageMixin, UpdateView):
    ...
    # return the obeject that we want to use
    ...
    # customize form such as adding placeholder in the form
    def get_form(self, form_class=None):
        ...
        form.fields["birthdate"].widget.attrs = {"placeholder": "Brithdate"}
